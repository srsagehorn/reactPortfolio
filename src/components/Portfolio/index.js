                  ...
                  <div class="col-md-6 col-12">
                    ...
                    <div class="col-md-6 col-12">
                      ...
                      <p class="card-text">
                        ...
                        Virus, and other mandatory sections. The final product
                        is an auto formatted pdf and embeddable html versions of
                        the syllabus. SyliGen is created with HTML/CSS,
                        Bootstrap, JS, Node, Express, MySQL. Deployed on Heroku.
                      </p>
                      <a
                ...
                <div class="card-body portCard">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <p class="card-text">
                        Notify is a group project created as a neighborhood
                        forum app. Users can log in and select their chicago
                        neighborhood, then post and notify their neighbors or
                        crime, events, lost dogs and much more. Notify was
                        created by HTML/CSS, JS, Node, Express, Handlebars,
                        MySQL, and SVG.
                      </p>
                      <a
                ...
                <div class="card-body portCard">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <p class="card-text">
                        CollabCal is a group project, and social networking
                        meets calendar app. Users can join calendar groups and
                        chat on each event to coordinate car pools or meeting
                        time. Users can also check if they are going or not.
                        CollabCal was made with HTML/CSS, JS, Node, Express,
                        React, MySQL,
                      </p>
                      <a
                        target="_blank"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <p class="card-text">
                        ...
                        friendly. The note taker is made with HTML/CSS
                        Bootstrap, JS, Node, and Express all deployed on Heroku.
                      </p>
                      <a
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <p class="card-text">
                        ...
                        professionals but the iCal leaves something to be
                        desired. This app uses the moment.js API to provide real
                        time scheduling. Set reminders, create and check off
                        to-do lists, and create events, with an easy-to-use UI.
                      </p>
                      <a
